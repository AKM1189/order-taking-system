...
@section('content')
    <div class="main-panel px-sm-5 px-3">
        <div class="content-wrapper">
            <h3 class="fs-3 mb-4">Purchase Lists</h3>

            <a href="/kitchen/purchase/create/menu" class="btn btn-danger mb-4">Purchase Menu</a>
            <a href="/kitchen/purchase/create/raw_material" class="btn btn-danger mb-4">Purchase Raw Material</a>


            <form action="/kitchen/purchase" method="GET">
                @csrf
                <div class="row mb-3">
                    ...
                    <div class="col-7 col-md-3">
                        <a href="/kitchen/purchase" class="btn btn-danger">All Purchase</a>
                    </div>
                </div>
            </form>
                ...
                <table class="table table-bordered" id="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="/kitchen/purchase/delete/{{$purchase->purchase_type == 'Menu Purchase'? 'menu' : 'rawmaterial'}}&{{$purchase->id}}" method='POST'>
                                    @csrf
                                    @method('DELETE')
                                    <a href="/kitchen/purchase/update/{{$purchase->purchase_type == 'Menu Purchase'? 'menu' : 'rawmaterial'}}&{{$purchase->id}}" class="text-decoration-none">Update</a>
...
<script>
    ...
    handleEmpty(data);
    $('#purchase').addClass('active text-danger');
</script>
