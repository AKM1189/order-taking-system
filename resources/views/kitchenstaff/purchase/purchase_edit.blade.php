...
<div class="d-flex justify-content-center">
    <div class="main-panel p-md-5 py-5 px-3 my-3 col-11 bg-light rounded-2 ">
        <div class="content-wrapper">
            <h3 class="fs-3 mb-4">Update Purchase</h3>
    
        <div class="p-0">
            <form action="/kitchen/purchase/update/{{$purchase->id}}" class="mt-5" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" name="purchase_type" class="form-control" id="purchase_type" value="{{$purchase->purchase_type}}" readonly>
    
                    </div>
                </div>
        
                <div class="menu-list bg-white rounded-3 p-sm-5 px-3 py-5 mt-5">
                    <h3>Add Items</h3>
