...
<div class="main-panel">
    ...
    <div class="col-10 p-0">
        <form action="/manager/purchase/create/{{$itemtype}}" class="mt-5" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-6">
                    ...
                    <input type="hidden" name="purchase_type" id="purchase_type" value="{{$itemtype=='menu'? 'Menu Purchase' : 'Raw Material Purchase'}}">
                </div>
